...
const tabs: Tab[] = [
  {
    ...
    content: (
      <>
        ...
        <Lead><p>대단한 디자인보다 방문자가 원하는 정보를 빠르게 찾을 수 있는 구조가 중심입니다. 만드는 것으로 끝이 아니라 오픈 후 수정·관리까지 맡아 드리니, 사장님은 본업에만 집중하시면 됩니다.</p></Lead>
        <InfoGrid cards={[
        ...
        <HighlightBox title="우리가 만드는 홈페이지의 특징">
          <BulletList items={["실용성 우선 — 방문자 편의성 중심 설계", "모바일 최적화", "오픈 후 수정·관리는 맡겨 두세요 — 유지보수까지 지원", "사업 성격에 맞춘 맞춤 디자인", "방문자 입장에서 정보 찾기 쉬운 메뉴 구성"]} />
        </HighlightBox>
      </>
    ),
  },
      ...
      <>
        ...
        <CaseList
          cases={[
            ...
            {
              tag: "유지보수",
              title: "공공기관·기업 시스템 유지보수",
              role: "SI 전문 기업에 재직하며 공공기관·기업의 실제 운영 중인 시스템을 분석하고 유지보수했습니다.",
              points: [
                "공공기관 CCTV 실시간 모니터링 웹 유지보수·배포",
                "공장 현장 데이터 관리 B2B 웹 시스템 화면·기능 개선",
                "대규모 레거시 코드를 분석해 안정적으로 유지보수",
              ],
              note: "남이 만든 시스템도 넘겨받아 고쳐 온 경험 — 유지보수에 강합니다.",
            },
          ]}
        />
    ...
    content: (
      <>
        ...
        <InfoGrid cards={[
          ...
          { num: "STEP 7", title: "오픈 & 사후 관리", desc: "홈페이지를 오픈하고, 이후 수정·유지보수까지 책임지고 관리해 드립니다." },
        ]} />
        <HighlightBox title="포함되는 작업">
          <BulletList items={["전체 페이지 디자인", "모바일 반응형 작업", "로고/이미지 기본 편집", "문의 폼·예약 시스템", "네이버 지도·SNS 연동", "도메인 연결 안내", "오픈 후 유지보수 지원"]} />
        </HighlightBox>
